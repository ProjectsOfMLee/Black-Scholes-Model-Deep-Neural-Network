...
def generate_data(n):
    # TODO: can modify the closed uniform [0,1] distribution to other distribution~[0,1]
    #return np.random.rand(n, 5)  # return np.random.random(n, 5)
    return np.random.uniform(0, 1, (n,5))
...
def main():
    ...
    xy = generate_black_scholes_put_data(20480)
